...
const index = ({busInfo , handelFetchBusInfo }) => {
    ...
    useEffect(() => {
        SuperFetch.get('/client/subscription/info', {headers: headers}).then((res) => {
    ...
    return (
        <>
            <Subscription subscriptions={subscriptions} merchant={merchant} handelFetchBusInfo={handelFetchBusInfo} isApiResponse={isApiResponse}/>
        </>
    )
