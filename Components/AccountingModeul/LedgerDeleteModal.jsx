...
const LedgerDeleteModal = ({ openModal, closeModal, deleteLedgerCategory }) => {
  return (
    <div>
      <Modal
        open={openModal}
        ...
        <Box>
          <div className="tableModalContent">
            ...
            <div className="category_delete_wrapper">
              <div className='confirm_btn' onClick={deleteLedgerCategory}>Yes</div>
...
export default LedgerDeleteModal;