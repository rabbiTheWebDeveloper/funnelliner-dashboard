...
const PayorDeleteModal = ({ openModal, closeModal, deletePayorCategory }) => {
  return (
    <div>
      <Modal
        open={openModal}
        ...
        <Box>
          <div className="tableModalContent">
            ...
            <div className="category_delete_wrapper">
              <div className='confirm_btn' onClick={deletePayorCategory}>Yes</div>
...
export default PayorDeleteModal;