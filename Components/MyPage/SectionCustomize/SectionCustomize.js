...
const SectionCustomize = () => {
    ...
    let options = productsList?.length === 0 ? [] : productsList?.map(function (item) {
    ...
    const onSubmit = (data) => {
        ...
        startLoading()
        axios.post(process.env.API_URL + `/client/page/update/${id}`, formData, { headers: headers })
                ...
                <Container maxWidth="sm">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Grid container spacing={3}>
                                ...
                                <div className="SectionCustomizeBox boxShadow">
                                    ...
                                    <div className="Form">
                                        ...
                                        <div className="customInput">
                                            <label>Title</label>
                                            <input {...register("title")} type="text" placeholder='Enter Title  name here' disabled />
                                        </div>

                                        {/* Meta description */}
                                        <div className="customInput">
                                            <label>Meta description</label>
                                            <textarea {...register("descriptions")} name="descriptions" rows="2" placeholder='Enter description here'></textarea>
                                        </div>
                                        ...
                                        <div className="customInput">
                                            ...
                                            {
                                                options.length > 0 && pageInfo && <AsyncSelect
                                                    placeholder="Select an option..."
                                                    options={options}
                                                    onChange={handleSelectChange}
                                                    defaultValue={options.find((item) => item.value === pageInfo?.product_id)}
                                                />
                                            }
                                        </div>
                                    </div>
                                            ...
                                            checkoutList.length > 0 && checkoutList.map((item, index) => {
                                                return (
                                                    <label className="SelectSectionItem" key={item.id}>
                                                        ...
                                                        <input checked defaultValue={item?.id}  {...register('checkout_form_id')} name="checkout_form_id" value={item?.id} key={item?.id} className="radio" type="radio" />
                                ...
                                <div className="SectionCustomizeBox boxShadow">
                                    ...
                                    <div className="Form">
                                        ...
                                        <div className="customInput">
                                            ...
                                            {errors.fb && <span style={{ color: "red" }}>{errors.fb.message}</span>}
                                        ...
                                        <div className="customInput">
                                            ...
                                            <input type="text"
                                                ...
                                                {...register('twitter',)} placeholder='https://www.twitter.com/' />
                                        ...
                                        <div className="customInput">
                                            <label>Youtube</label>
                                            <input defaultValue={pageInfo?.youtube} type="text"
                                                {...register("youtube", {
                                                    pattern: {
                                                        value: /^(https?:\/\/)?(www\.)?youtube\.com\/watch\?v=[\w-]{11}$/,
                                                        message: "Invalid youtube profile link",
                                                    },
                                                })}
                                                placeholder='https://www.youtube.com/' />
                                            {errors.youtube && <span style={{ color: "red" }}>{errors.youtube.message}</span>}
                                        </div>
                            ...
                            <Grid item xs={6}>
                                ...
                                <div className="SectionCustomizeBox boxShadow">
                                    ...
                                    <div className="Form">
                                        ...
                                        <div className="customInput">
                                            <label>Email</label>
                                            <input defaultValue={pageInfo?.email} {...register('email', {
                                                pattern: {
                                        ...
                                        <div className="customInput">
                                            <label>Address</label>
                                            <input defaultValue={pageInfo?.address} {...register('address')} type="text" placeholder='Enter Enter your address' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="SectionCustomizeBox boxShadow">
                                    ...
                                    <div className="SelectSectionBox">
                                        {
                                            pageInfo?.active_footer && footerList.length > 0 && footerList.map((item, index) => {
                                                return (
                                                    <label className="SelectSectionItem" key={item.id}>

                                                        <input defaultChecked={item?.id == pageInfo?.active_footer?.footer_id}  {...register('footer_id')} name="footer_id" value={item?.id} key={item?.id} className="radio" type="radio" />
                                        ...
                                        <div className="imgUploader">
...

                                            {
                                                imageUrl && selectedImage ? "" : <Box mt={2} textAlign="center">
                                                    {/* <h6>Image Preview:</h6> */}
                                                    <img src={pageInfo?.logo} alt={pageInfo?.title} height="100px" />
                                                </Box>
                                            }
                                        </div>
                                    </div>
                                        ...
                                        <div className="ColorSectionItem">
                                            ...
                                            <div className="customInput">
                                                ...
                                                <div className="showColor">
                                                    ...
                                                    <input defaultValue={pageInfo?.checkout_text_color} {...register('checkout_text_color',)} type="color" />
                                                </div>
                                            </div>
                                            <div className="customInput">
                                                <label>Link </label>
                                                <div className="showColor">
                                                    ...
                                                    <input defaultValue={pageInfo?.checkout_link_color}  {...register('checkout_link_color')} type="color" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="customInput">
                                                ...
                                                <div className="showColor">
                                                    ...
                                                    <input defaultValue={pageInfo?.checkout_b_color} {...register('checkout_button_color',)} type="color" />
                                                </div>
                                            </div>
                                            <div className="customInput">
                                                ...
                                                <div className="showColor">
                                                    <h4>{pageInfo?.checkout_b_color}</h4>
                                                    <input defaultValue={pageInfo?.checkout_b_color} {...register('checkout_b_color',)} type="color" />
                                                </div>
                                            </div>
                                        ...
                                        <div className="ColorSectionItem">
                                            ...
                                            <div className="customInput">
                                                ...
                                                <div className="showColor">
                                                    ...
                                                    <input {...register('footer_text_color')} type="color" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="customInput">
                                                ...
                                                <div className="showColor">
                                                    ...
                                                    <input {...register('footer_heading_color')} type="color" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="customInput">
                                                ...
                                                <div className="showColor">
                                                    ...
                                                    <input defaultValue={pageInfo?.footer_b_color} {...register('footer_b_color')} type="color" />
                                                </div>
                                            </div>
                            ...
                            {/* Save */}
                            <Grid item xs={6}>
                                <Button disabled={isLoading} type='submit' className="bg">Save Data</Button>
                            </Grid>
